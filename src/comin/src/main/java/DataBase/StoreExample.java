...
public class StoreExample {
	...
	static final String inputFileName = "br/ufg/inf/rdf/vc-db-2.rdf";
	...
	public static void main(String args[]) {
		...
		// Transferindo o MODELO RDF em mem�ria para o BD relacional
		...
		// Cria��o de String de consulta na sintaxe da linguagem SPARQL
		// String queryString = "SELECT ?s ?p ?o " +
		// "WHERE {?s ?p ?o}";

		// Consulta �s TRIPLAS armazenadas no BD
